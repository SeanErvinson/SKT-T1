...
public class ActivityTable {
    ...
    public static String getCreateQuery() {
        return String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY, %s TEXT NOT NULL, %s LONG NOT NULL, %s BOOLEAN NOT NULL)", TABLE, COL_ID, COL_MESSAGE, COL_NOTIFIED_ON, COL_HAS_READ);
    }
}
