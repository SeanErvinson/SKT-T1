...
public class TagTable {
    ...
    public static final String COL_SOUND_ALARM = "sound_alarm";
    ...
    public static String getCreateQuery() {
        return String.format("CREATE TABLE %s " +
                ...
                "%s INTEGER NOT NULL," +
                "%s LONG NOT NULL, %s INTEGER NOT NULL, " +
                "%s INTEGER NOT NULL," +
                " FOREIGN KEY(%s) REFERENCES %s (%s) ON DELETE SET NULL)", TABLE, COL_ID, COL_NAME, COL_MAC_ADDRESS, COL_LAST_SEEN_LOCATION_ID, COL_LAST_SEEN_TIME, COL_SOUND_ALARM, COL_ALARM, COL_LAST_SEEN_LOCATION_ID, LocationTable.TABLE, LocationTable.COL_ID);
    }
}
